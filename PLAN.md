...
- **Privacy policy URL:** https://devendrap7.github.io/Riddles-fun/privacy-policy.html (live, GitHub Pages).
...
## Content
- 100 fun riddles, AI-generated + verified, bundled as local JSON.
- Text answers → normalize (trim/lowercase/strip spaces) before match; may need alias matching.
